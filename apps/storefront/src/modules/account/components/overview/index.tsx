            ...
            <div className="flex items-start gap-x-16 mb-6">
              <div className="flex flex-col gap-y-4">
                ...
                <div className="flex items-end gap-x-2">
                  ...
                  <span className="uppercase text-base-regular text-ui-fg-subtle">Completado</span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-y-4">
                ...
                <div className="flex items-end gap-x-2">
                  ...
                  <span className="uppercase text-base-regular text-ui-fg-subtle">Guardadas</span>
                </div>
              </div>
            </div>
