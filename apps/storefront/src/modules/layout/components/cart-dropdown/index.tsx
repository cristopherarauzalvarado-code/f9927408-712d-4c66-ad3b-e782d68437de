      ...
      <Popover className="relative h-full">
        <PopoverButton className="h-full flex items-center">
          ...
          >
            ...
            {totalItems > 0 && (
              <span
                className="absolute -top-2 -right-2 flex h-[18px] min-w-[18px] items-center justify-center rounded-full bg-brand px-1 text-[10px] font-semibold leading-none text-brand-foreground"
